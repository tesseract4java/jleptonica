...
/**
 * The 'special' field is by default 0, but it can hold integers<br>
 * that direct non-default actions, e.g., in png and jpeg I/O.<br>
...
public class Pix extends Structure {
	 ...
	 * C type : PixColormap*
	 */
	public de.vorb.leptonica.PixColormap.ByReference colormap;
	/**
	 * the image data<br>
	 * C type : l_uint32*
	 */
