...
public class GPlot extends Structure {
	 ...
	 * C type : Sarray*
	 */
	public de.vorb.leptonica.Sarray.ByReference cmddata;
	/**
	 * data file names<br>
	 * C type : Sarray*
	 */
	public de.vorb.leptonica.Sarray.ByReference datanames;
	/**
	 * plot data (1 string/file)<br>
	 * C type : Sarray*
	 */
	public de.vorb.leptonica.Sarray.ByReference plotdata;
	/**
	 * title for each individual plot<br>
	 * C type : Sarray*
	 */
	public de.vorb.leptonica.Sarray.ByReference plottitles;
	/**
	 * plot style for individual plots<br>
	 * C type : Numa*
	 */
	public de.vorb.leptonica.Numa.ByReference plotstyles;
	/**
