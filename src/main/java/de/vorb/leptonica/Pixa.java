 ...
 * tesseract-vs2013\liblept\include\pix.h:406</i><br>
 ...
 */
@Library("leptonica")
public class Pixa extends StructObject {
    static {
        BridJ.register();
    }
     ...
     */
    @Field(2)
    public Pixa refcount(int refcount) {
     ...
     */
    @Field(3)
    public Pointer<Pointer<Pix>> pix() {
     ...
     */
    @Field(3)
    public Pixa pix(Pointer<Pointer<Pix>> pix) {
     ...
     */
    @Field(4)
    public Pixa boxa(Pointer<Boxa> boxa) {
