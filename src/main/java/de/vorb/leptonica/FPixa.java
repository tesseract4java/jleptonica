...
/**
 * <i>native declaration : C:\Users\Paul\Studium\Masterarbeit\Entwicklung\VS2013\tesseract-vs2013\liblept\include\pix.h:537</i><br>
...
public class FPixa extends Structure {
	 ...
	 * C type : FPix**
	 */
	public de.vorb.leptonica.FPix.ByReference[] fpix;
	public FPixa() {
		super();
	}
	 ...
	 * C type : FPix**
	 */
	public FPixa(int n, int nalloc, int refcount, de.vorb.leptonica.FPix.ByReference fpix[]) {
		super();
		this.n = n;
		this.nalloc = nalloc;
